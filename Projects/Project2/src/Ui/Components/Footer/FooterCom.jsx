            ...
            <div className="col-sm-12 col-md">
              <div className="ftco-footer-widget mb-4 ml-md-4">
                ...
                <ul className="list-unstyled">
                  <li>
                    <a href="#">
                      <span className="fa fa-chevron-right mr-2"></span>My
                      Account
                    </a>
                  </li>
                  <li>
            ...
            <div className="col-sm-12 col-md">
              <div className="ftco-footer-widget mb-4">
                ...
                <ul className="list-unstyled">
                  <li>
                    <a href="#">
                      <span className="fa fa-chevron-right mr-2"></span>New User
                    </a>
                  </li>
                  <li>
                    <a href="#">
                  ...
                  <li>
                    <a href="#">
                      <span className="fa fa-chevron-right mr-2"></span>Report
                      Spam
                    </a>
                  </li>
                  <li>
